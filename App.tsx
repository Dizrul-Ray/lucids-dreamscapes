    ...
    <main className="page">
      <header className="panel">
        <div className="header-row">
          <div>
            <p className="eyebrow">Creative Writing Studio</p>
            <h1>Build stories with momentum.</h1>
            <p className="muted">Draft scenes, save versions, and organize character intent in one place.</p>
          </div>
